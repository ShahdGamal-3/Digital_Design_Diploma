...
set perspective_DateTime   {2025-03-08T21:10:17}
set perspective_Directory  {E:/Material/DigitalDesign/projects/lint}
set perspective_USER       {shahd}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###source,zincdcdutview,zinlintDesignMetricsView,zinlintMsgSummaryView,transcript,zinlintDesignInfoView,zinmsgviewer,zindetails,zinlintMsgView,zindirectiveseditor,source,zinlintMsgStatusHistoryView,zinflownavigator,zinlintMsgDashboardView -hide -description none -label none
...
pref::set -type string -category Lint -name lintMessagesviewDefaultOrderWidth -value Severity:127,Status:60,Check:250,Alias:100,Message:1016,Module:150,Category:150,State:100,Owner:100,STARC*Reference:100 -hide -description none -label none
